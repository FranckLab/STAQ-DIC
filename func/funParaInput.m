...
switch paraName
    ...
    case 'NewFFTSearch' % For an image sequence: re-run FFT for an initial guess or not?
        ...
        fprintf('    0: Use last frame (cumulative mode: by default); \n');
        fprintf('    1: Redo initial guess (incremental mode: by default). \n');
    ...
    case 'ConvertUnit' % Convert units from pixels to the physical world
        ...
        display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
        fprintf("Results in Section 8 (ResultStrain), Section 9 \n(ResultStress), and all the plots will be converted to the physical world unit instead of the pixel unit.  \n");
        display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
