function PlotaccelQuadtreePolarMasks(U,A,coordinatesFEM,elementsFEM,CurrentImg,CurrentImgMask,...
    DICpara,ImgSeqNum,Rnew,CircleFitPar)
%PLOTACCELQUADTREE: to plot DIC solved displacement components  
%   PlotaccelQuadtree(U,V,coordinatesFEMWorld,elementsFEM,CurrentImg,DICpara)
% ----------------------------------------------
%
...
hold on; ax2=axes; h2=show([],elementsFEM(:,1:4),coordinatesFEMWorldDef/um2px,accel_r,'NoEdgeColor');
...
axis equal; axis tight; box on; set(gca,'fontSize',18); view(2);  set(gca,'ydir','normal');
hold on; ax2=axes; h2=show([],elementsFEM(:,1:4),coordinatesFEMWorldDef/um2px,accel_t,'NoEdgeColor');
set(gca,'fontSize',18); view(2); box on; axis equal;  axis tight;   
alpha(h2,OrigDICImgTransparency); colormap(cMap); caxis auto;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% TODO: manually modify colormap and caxis %%%%%%
